...
@implementation DDBannerViewWithURL
...
-(void)setIntervalTimer:(float)IntervalTimer{
    
    _IntervalTimer = IntervalTimer;
    [mv_timer setFireDate:[NSDate dateWithTimeIntervalSinceNow:IntervalTimer]];
}
